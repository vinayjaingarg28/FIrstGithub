    ...
    <td width="759" valign="top" bgcolor="#E8E1C7">
           <form action="DeanComment"  method="post" >
            ...
            String authority = (String)session.getAttribute("authority");
                       ...
                       Form2 f2 = db.Admin.getFormListByEmail(uid);
                       if(!(f2==null)){
        ...
        <%
                 ...
                 ArrayList list = db.Admin.getForm1(f2.getReportid());
    ...
    <div>
                <table class="gfg">
                    ...
                    <tr>
                        ...
                        <td><textarea name="deancomment" rows="3" cols="80" readonly><%=f2.getDeancomment()%></textarea></td>
                    </tr>
                </table>
                    <%}
                    else
{
out.println("Plz fill your fortnight first");
