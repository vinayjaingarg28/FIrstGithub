...
<table width="100%" height="492" border="1">
  ...
  Hello , U r Login as - <%=authority%> 
        ...
        <tr>
         <td width="22%" bordercolor="#4E3A3" bgcolor="black" ><div align="center" class="style11"><a href="ViewProfiledg.jsp">View Profile</a></div></td>
   </tr>
   <tr>
     
         <td width="16%" bordercolor="#4E3A34" bgcolor="black"><div align="center" class="style4"><a href="ViewPenDg.jsp">Pending Report</a></div></td>
   </tr>
   <tr>
